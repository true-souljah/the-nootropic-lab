...
import { productsAU, regionsWithProduct, buildProductSchema, getRegionalHealthDisclaimer } from '@nootropic/data';
...
export async function generateMetadata({
  ...
  return {
    title,
    description,
    alternates: buildAlternates({ regionCode: 'au', path: `/${slug}/`, availableInRegions: regionsWithProduct(slug) }),
