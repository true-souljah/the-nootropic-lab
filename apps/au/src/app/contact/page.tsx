...
export const metadata: Metadata = {
  title: 'Contact The Nootropic Lab AU',
  description:
    'Editorial corrections, partnership inquiries, reader feedback. Reach The Nootropic Lab editorial team.',
  alternates: buildAlternates({ regionCode: 'au', path: '/contact/' }),
  openGraph: buildOpenGraph({ regionCode: 'au', path: '/contact/', title: 'Contact The Nootropic Lab AU', description: 'Editorial corrections, partnership inquiries, reader feedback. Reach The Nootropic Lab editorial team.' }),
  twitter: buildTwitter({ title: 'Contact The Nootropic Lab AU', description: 'Editorial corrections, partnership inquiries, reader feedback. Reach The Nootropic Lab editorial team.' }),
};
...
const contactSchema = {
  ...
  name: 'Contact The Nootropic Lab AU',
};
