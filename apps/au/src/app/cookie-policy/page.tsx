...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates({ regionCode: 'au', path: '/cookie-policy/' }),
  openGraph: buildOpenGraph({ regionCode: 'au', path: '/cookie-policy/', title: 'Cookie Policy', description: 'Cookie policy for The Nootropic Lab. What cookies we use and how to control them.' }),
