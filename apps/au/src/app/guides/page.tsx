...
export const metadata: Metadata = {
  ...
  openGraph: buildOpenGraph({ regionCode: 'au', path: '/guides/', title: `Nootropics Guides ${CURRENT_YEAR} — Australia, Beginner to Advanced`, description: 'Learn everything about nootropics available in the EU: what they are, how they work, how to stack them safely, and what to realistically expect.' }),
  twitter: buildTwitter({ title: `Nootropics Guides ${CURRENT_YEAR} — Australia, Beginner to Advanced`, description: 'Learn everything about nootropics available in the EU: what they are, how they work, how to stack them safely, and what to realistically expect.' }),
};
