...
export const metadata: Metadata = {
  ...
  openGraph: buildOpenGraph({ regionCode: 'au', path: '/imprint/', title: 'Imprint — The Nootropic Lab Australia', description: 'Imprint for the Australian edition of The Nootropic Lab. Publisher information, contact details, editorial standards, and affiliate-disclosure policy.' }),
  twitter: buildTwitter({ title: 'Imprint — The Nootropic Lab Australia', description: 'Imprint for the Australian edition of The Nootropic Lab. Publisher information, contact details, editorial standards, and affiliate-disclosure policy.' }),
};
