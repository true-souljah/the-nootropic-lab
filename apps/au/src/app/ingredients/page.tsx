...
export const metadata: Metadata = {
  title: `Nootropic Ingredients Guide ${CURRENT_YEAR} — Australia, Clinical Doses & Evidence`,
  description:
...
export default function IngredientsPage() {
  const schema = {
    ...
    '@type': 'ItemList',
    name: 'Nootropic Ingredients Comparison — Australia',
    numberOfItems: ingredients.length,
    itemListElement: ingredients.map((ing, i) => ({
      '@type': 'ListItem',
      position: i + 1,
      name: ing.name,
      url: `https://au.thenootropiclab.com/ingredients/${ing.slug}`,
    })),
  };
