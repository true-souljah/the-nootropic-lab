...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates({ regionCode: 'au', path: '/methodology/' }),
  openGraph: buildOpenGraph({ regionCode: 'au', path: '/methodology/', title: 'How We Review Nootropics — Our Methodology', description: 'The Nootropic Lab scoring methodology: 5-pillar framework, clinical dosing audit process, and full affiliate disclosure.' }),
