...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates({ regionCode: 'au', path: '/privacy-policy/' }),
  openGraph: buildOpenGraph({ regionCode: 'au', path: '/privacy-policy/', title: 'Privacy Policy', description: 'Privacy policy for The Nootropic Lab. How we collect, use, and protect your data.' }),
