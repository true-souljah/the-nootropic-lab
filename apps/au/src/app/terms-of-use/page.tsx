...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates({ regionCode: 'au', path: '/terms-of-use/' }),
  openGraph: buildOpenGraph({ regionCode: 'au', path: '/terms-of-use/', title: TITLE, description: DESCRIPTION }),
