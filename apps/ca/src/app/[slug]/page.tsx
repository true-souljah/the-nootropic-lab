...
import { productsCA, regionsWithProduct, buildProductSchema, getRegionalHealthDisclaimer } from '@nootropic/data';
...
export function generateStaticParams() {
  return productsCA.map((p) => ({ slug: p.slug }));
}
...
export async function generateMetadata({
  ...
  return {
    title,
    description,
    alternates: buildAlternates({ regionCode: 'ca', path: `/${slug}/`, availableInRegions: regionsWithProduct(slug) }),
