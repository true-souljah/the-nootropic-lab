...
const contactSchema = {
  ...
  name: 'Contact The Nootropic Lab Canada',
};
        ...
        <div className="space-y-6">
          <section className="border border-gray-200 rounded-xl p-5">
            ...
            <p className="text-sm text-gray-700 mb-2">
              Spotted a factual error in a review? Found an outdated price, a discontinued SKU, or an
              NPN-listing change? We update content based on documented corrections.
            </p>
            <a
              href="mailto:editorial@thenootropiclab.com?subject=Correction%20request%20(CA)"
          ...
          <section className="border border-gray-200 rounded-xl p-5">
            ...
            <p className="text-sm text-gray-700 mb-2">
              Had an experience with a brand we cover? Want to share a subscription-cancellation or
              cross-border-shipping story? We use reader-survey data in our brand-trust scoring.
            </p>
            <a
              href="mailto:readers@thenootropiclab.com?subject=Reader%20feedback%20(CA)"
              className="inline-block text-green-700 underline text-sm font-medium"
            >
          ...
          <section className="border border-gray-200 rounded-xl p-5">
            ...
            <a
              href="mailto:partnerships@thenootropiclab.com?subject=Partnership%20inquiry%20(CA)"
              className="inline-block text-green-700 underline text-sm font-medium"
            >
