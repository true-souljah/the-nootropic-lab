...
export const metadata: Metadata = {
  title: `Nootropics Guides ${CURRENT_YEAR} — Canada, Beginner to Advanced`,
  description:
    'Learn everything about nootropics available in Canada: what they are, how they work, how to stack them safely, and what to realistically expect.',
  alternates: buildAlternates({ regionCode: 'ca', path: '/guides/' }),
  openGraph: buildOpenGraph({ regionCode: 'ca', path: '/guides/', title: `Nootropics Guides ${CURRENT_YEAR} — Canada, Beginner to Advanced`, description: 'Learn everything about nootropics available in Canada: what they are, how they work, how to stack them safely, and what to realistically expect.' }),
  twitter: buildTwitter({ title: `Nootropics Guides ${CURRENT_YEAR} — Canada, Beginner to Advanced`, description: 'Learn everything about nootropics available in Canada: what they are, how they work, how to stack them safely, and what to realistically expect.' }),
};
...
export default function GuidesPage() {
  const schema = {
    ...
    '@type': 'ItemList',
    name: 'Nootropics Guides — Canada',
    numberOfItems: guides.length,
    itemListElement: guides.map((g, i) => ({
      '@type': 'ListItem',
      position: i + 1,
      name: g.title,
      url: `https://ca.thenootropiclab.com/guides/${g.slug}`,
    })),
  };
