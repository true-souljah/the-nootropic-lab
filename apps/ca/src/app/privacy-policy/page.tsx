...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates({ regionCode: 'ca', path: '/privacy-policy/' }),
  openGraph: buildOpenGraph({ regionCode: 'ca', path: '/privacy-policy/', title: 'Privacy Policy', description: 'Privacy policy for The Nootropic Lab. How we collect, use, and protect your data.' }),
