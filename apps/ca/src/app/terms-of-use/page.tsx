...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates({ regionCode: 'ca', path: '/terms-of-use/' }),
  openGraph: buildOpenGraph({ regionCode: 'ca', path: '/terms-of-use/', title: TITLE, description: DESCRIPTION }),
