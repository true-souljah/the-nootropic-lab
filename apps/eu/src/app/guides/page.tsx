...
export const metadata: Metadata = {
  title: `Nootropics Guides ${CURRENT_YEAR} — EU Edition, Beginner to Advanced`,
  description:
  ...
  alternates: buildAlternates({ regionCode: 'eu', path: '/guides/' }),
  openGraph: buildOpenGraph({ regionCode: 'eu', path: '/guides/', title: `Nootropics Guides ${CURRENT_YEAR} — EU Edition, Beginner to Advanced`, description: 'Learn everything about nootropics available in the EU: what they are, how they work, how to stack them safely, and what to realistically expect.' }),
  twitter: buildTwitter({ title: `Nootropics Guides ${CURRENT_YEAR} — EU Edition, Beginner to Advanced`, description: 'Learn everything about nootropics available in the EU: what they are, how they work, how to stack them safely, and what to realistically expect.' }),
};
