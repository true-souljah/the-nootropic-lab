...
export const alt = 'The Nootropic Lab — EU Edition';
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
          ...
          <div style={{ fontSize: 28, opacity: 0.85, fontWeight: 500 }}>
            EU Edition · CE-aligned · Evidence-graded
          </div>
        </div>

        <div style={{ fontSize: 20, opacity: 0.7, letterSpacing: 0.3 }}>eu.thenootropiclab.com</div>
      </div>
    ),
    { ...size },
  );
