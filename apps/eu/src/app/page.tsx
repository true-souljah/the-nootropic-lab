  ...
  return (
    <PublicShell searchItems={searchItems} uiStrings={uiStrings}>
      ...
      <section className="max-w-5xl mx-auto px-4 pb-16">
        ...
        <p className="text-sm text-gray-500 mb-6">Different ingredients suit different cognitive goals. EU-storefront picks only.</p>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <Link href="/best-nootropics-for-aging/" className="block border border-gray-200 rounded-lg p-4 hover:border-green-700 transition-colors">
            ...
            <div className="text-xs text-gray-500">PS, citicoline, Lion&apos;s Mane</div>
          </Link>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-4 pb-16">
        ...
        <p className="text-sm text-gray-500 mb-6">National supplement rules, customs handling and shipping times for each EU member state.</p>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {euCountries.slice(0, 11).map(p => (
          ...
          <Link href="/countries/" className="block border border-green-700 rounded-lg p-4 bg-green-50 hover:bg-green-100 transition-colors">
            <div className="font-semibold text-green-800 text-sm">All EU countries →</div>
          </Link>
        </div>
      </section>
    </PublicShell>
