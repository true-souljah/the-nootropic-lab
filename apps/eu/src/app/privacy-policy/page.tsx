...
export const metadata: Metadata = {
  ...
  openGraph: buildOpenGraph({ regionCode: 'eu', path: '/privacy-policy/', title: 'Privacy Policy', description: 'Privacy policy for The Nootropic Lab. How we collect, use, and protect your data.' }),
