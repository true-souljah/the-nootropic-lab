...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates({ regionCode: 'eu', path: '/terms-of-use/' }),
  openGraph: buildOpenGraph({ regionCode: 'eu', path: '/terms-of-use/', title: TITLE, description: DESCRIPTION }),
