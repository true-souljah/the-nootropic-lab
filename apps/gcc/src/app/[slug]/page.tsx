...
import { productsGCC, regionsWithProduct, buildProductSchema, getRegionalHealthDisclaimer } from '@nootropic/data';
...
export async function generateMetadata({
  ...
  return {
    title,
    description,
    alternates: buildAlternates({ regionCode: 'gcc', path: `/${slug}/`, availableInRegions: regionsWithProduct(slug) }),
...
export default async function ProductReviewPage({
  ...
  const alternatives = productsGCC
