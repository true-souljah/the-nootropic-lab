...
export const metadata: Metadata = {
  ...
  description:
    'The Nootropic Lab GCC is an independent cognitive-supplement comparison site for buyers in Saudi Arabia, UAE, Qatar, Kuwait, Bahrain, and Oman. Operated by Kulik Media UG. Evidence-graded reviews, clinical dosing audits, transparent affiliate disclosure.',
