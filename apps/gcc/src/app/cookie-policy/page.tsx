...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates({ regionCode: 'gcc', path: '/cookie-policy/' }),
  openGraph: buildOpenGraph({ regionCode: 'gcc', path: '/cookie-policy/', title: 'Cookie Policy', description: 'Cookie policy for The Nootropic Lab. What cookies we use and how to control them.' }),
  twitter: buildTwitter({ title: 'Cookie Policy', description: 'Cookie policy for The Nootropic Lab. What cookies we use and how to control them.' }),
};
