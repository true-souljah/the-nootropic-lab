...
import { ingredients, productsGCC, buildPersonAuthorReference } from '@nootropic/data';
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: buildOpenGraph({ regionCode: 'gcc', path: `/ingredients/${ingredient}/`, title: `${ing.name} — Nootropic Guide, Dosing, Effects & FAQs`, description: `${ing.name}: mechanism of action, clinical dose (${ing.clinicalDose}), human effect matrix, how to take, stacking guide, and consumer FAQs — products with international shipping.` }),
        ...
        {containingProducts.length > 0 && (
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-4">
              GCC Stacks Containing {ing.name}
            </h2>
