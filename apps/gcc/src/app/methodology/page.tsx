...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates({ regionCode: 'gcc', path: '/methodology/' }),
  openGraph: buildOpenGraph({ regionCode: 'gcc', path: '/methodology/', title: 'How We Review Nootropics — Our Methodology', description: 'The Nootropic Lab scoring methodology: 5-pillar framework, clinical dosing audit process, and full affiliate disclosure.' }),
...
const pillars = [
  ...
  { num: '05', title: 'Brand trust (20%)', desc: 'Composite of Trustpilot score (50%), complaint volume, subscription cancellation transparency, and third-party testing documentation.' },
];
      ...
      <article className="max-w-3xl mx-auto px-4 py-10">
        ...
        <section className="mb-10">
          ...
          <p className="text-sm text-gray-600 leading-relaxed">
            The Nootropic Lab earns affiliate commissions when readers purchase products through our
            links. This does not influence our editorial scores or rankings. All affiliate
            relationships are disclosed on every page where they apply.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-sm text-gray-600 leading-relaxed">
            Content on The Nootropic Lab is for informational purposes only and does not constitute
            medical advice. Always consult a qualified healthcare professional before taking any
            supplement.
          </p>
        </section>
