...
export const alt = 'The Nootropic Lab — Gulf Edition';
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
          ...
          <div style={{ fontSize: 28, opacity: 0.85, fontWeight: 500 }}>
            Gulf Edition · Halal-certified options · Evidence-graded
          </div>
        </div>

        <div style={{ fontSize: 20, opacity: 0.7, letterSpacing: 0.3 }}>gcc.thenootropiclab.com</div>
      </div>
    ),
    { ...size },
  );
