...
import { guides, buildPersonAuthorReference, productsJP, regionalGuideNote, regionalTitleQualifier } from '@nootropic/data';
  ...
  return (
    <PublicShell searchItems={searchItems} uiStrings={uiStrings}>
      ...
      <article className="max-w-3xl mx-auto px-4 py-10">
        ...
        <RegionalAvailability {...regionalProps(productsJP.slice().sort((a, b) => b.score - a.score).slice(0, 4))} note={regionalGuideNote('jp', g.slug)} />
