...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates({ regionCode: 'jp', path: '/ingredients/' }),
  openGraph: buildOpenGraph({ regionCode: 'jp', path: '/ingredients/', title: `Nootropic Ingredients Guide ${CURRENT_YEAR} — Clinical Doses & Evidence`, description: 'Compare evidence-backed nootropic ingredients. Clinical doses, mechanisms, time to effect, and which products contain them.' }),
