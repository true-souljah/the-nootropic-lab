...
export const metadata: Metadata = {
  title: `Nootropic Ingredients Guide ${CURRENT_YEAR} — Japan, Clinical Doses & Evidence`,
  description:
...
export default function IngredientsPage() {
  const schema = {
    ...
    '@type': 'ItemList',
    name: 'Nootropic Ingredients Comparison — Japan',
    numberOfItems: ingredients.length,
    itemListElement: ingredients.map((ing, i) => ({
      '@type': 'ListItem',
      position: i + 1,
      name: ing.name,
      url: `https://jp.thenootropiclab.com/ingredients/${ing.slug}`,
    })),
  };
