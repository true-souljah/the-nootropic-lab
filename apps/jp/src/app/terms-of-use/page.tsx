...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates({ regionCode: 'jp', path: '/terms-of-use/' }),
  openGraph: buildOpenGraph({ regionCode: 'jp', path: '/terms-of-use/', title: TITLE, description: DESCRIPTION }),
