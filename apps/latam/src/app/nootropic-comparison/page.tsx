...
export const metadata: Metadata = {
  ...
  openGraph: buildOpenGraph({ regionCode: 'latam', path: '/nootropic-comparison/', title: 'Nootropic Comparator — Filter and Compare Side-by-Side (LATAM)', description: 'Filter by goal, price, grade, caffeine, EU compliance, and hands-on testing. Sort by score, price, value, or Trustpilot. Pick up to 3 products to compare side-by-side.' }),
  twitter: buildTwitter({ title: 'Nootropic Comparator — Filter and Compare Side-by-Side (LATAM)', description: 'Filter by goal, price, grade, caffeine, EU compliance, and hands-on testing. Sort by score, price, value, or Trustpilot. Pick up to 3 products to compare side-by-side.' }),
};
