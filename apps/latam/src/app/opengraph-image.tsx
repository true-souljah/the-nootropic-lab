...
export const alt = 'The Nootropic Lab — Edición Latinoamérica';
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
          <div style={{ fontSize: 64, fontWeight: 800, lineHeight: 1.05, letterSpacing: -1.5, maxWidth: 980 }}>
            Reseñas independientes de suplementos cognitivos
          </div>
          <div style={{ fontSize: 28, opacity: 0.85, fontWeight: 500 }}>
            Edición Latinoamérica · Envío internacional · Evidencia clínica
          </div>
        </div>

        <div style={{ fontSize: 20, opacity: 0.7, letterSpacing: 0.3 }}>latam.thenootropiclab.com</div>
      </div>
    ),
    { ...size },
  );
