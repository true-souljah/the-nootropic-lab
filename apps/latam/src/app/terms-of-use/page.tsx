...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates({ regionCode: 'latam', path: '/terms-of-use/' }),
  openGraph: buildOpenGraph({ regionCode: 'latam', path: '/terms-of-use/', title: TITLE, description: DESCRIPTION }),
