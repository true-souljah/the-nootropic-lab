...
export async function generateMetadata({
  ...
  if (!product) return {};
  return {
    title: `${product.name} Review 2026 — Southeast Asia Buyer's Guide`,
    description: `Independent Southeast Asia review of ${product.name}. Score: ${product.score}/10. Clinical dosing audit and full affiliate disclosure.`,
  };
}
...
export default async function ProductReviewPage({
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Best Nootropics', item: 'https://sea.thenootropiclab.com/best-nootropics' },
      ...
      <article className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="mb-6">
          <div className="flex flex-wrap items-center gap-2 mb-2">
            {product.editorChoice && (
              <span className="editor-badge">Editor&apos;s Choice — Southeast Asia 2026</span>
            )}
        ...
        <div className="text-sm text-gray-500">
          <a href="/best-nootropics" className="text-green-700 underline">
            ← Back to Best Nootropics Southeast Asia 2026
          </a>
        </div>
      </article>
    </>
