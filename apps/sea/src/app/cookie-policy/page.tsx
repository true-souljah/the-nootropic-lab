...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates({ regionCode: 'sea', path: '/cookie-policy/' }),
  openGraph: buildOpenGraph({ regionCode: 'sea', path: '/cookie-policy/', title: 'Cookie Policy', description: 'Cookie policy for The Nootropic Lab. What cookies we use and how to control them.' }),
