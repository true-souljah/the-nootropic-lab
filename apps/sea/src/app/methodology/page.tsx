...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates({ regionCode: 'sea', path: '/methodology/' }),
  openGraph: buildOpenGraph({ regionCode: 'sea', path: '/methodology/', title: 'How We Review Nootropics — Our Methodology', description: 'The Nootropic Lab scoring methodology: 5-pillar framework, clinical dosing audit process, and full affiliate disclosure.' }),
