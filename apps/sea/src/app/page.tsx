...
const websiteSchema = {
  ...
  '@type': 'WebSite',
  name: 'The Nootropic Lab SEA',
  url: 'https://sea.thenootropiclab.com',
  description: 'Independent cognitive supplement reviews for Southeast Asia buyers.',
};
...
const orgSchema = {
  ...
  url: 'https://sea.thenootropiclab.com',
  logo: 'https://sea.thenootropiclab.com/logo.png',
...
const features = [
  ...
  {
    icon: '🌏',
    title: 'SEA regulatory notes',
    desc: 'HSA (Singapore), NPRA (Malaysia), Thai FDA, FDA Philippines, BPOM (Indonesia) — regulatory import status noted for each country.',
  },
  {
    icon: '⚖️',
      ...
      <section className="bg-gradient-to-b from-green-50 to-white py-16 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-block bg-green-100 text-green-800 text-xs font-semibold px-3 py-1 rounded-full mb-4">
            SEA Market · Evidence-Graded · Affiliate-Disclosed
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-4">
            The Independent SEA Guide to
            <br />
            <span className="text-green-700">Cognitive Supplements</span>
          </h1>
          <p className="text-lg text-gray-600 mb-8 max-w-xl mx-auto">
            Evidence-graded nootropic reviews for buyers across Southeast Asia. Regulatory
            import notes for Singapore, Malaysia, Thailand, Philippines, Indonesia, and Vietnam.
          </p>
