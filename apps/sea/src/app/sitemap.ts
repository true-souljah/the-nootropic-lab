...
import { productsSEA, ingredients, guides, seaCountries } from '@nootropic/data';
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/halal-nootropics-indonesia-bpjph/`, lastModified: now, changeFrequency: 'monthly', priority: 0.75 },
  ...
  const countryPages: MetadataRoute.Sitemap = seaCountries.map(c => ({
