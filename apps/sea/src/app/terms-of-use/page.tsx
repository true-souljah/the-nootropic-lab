...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates({ regionCode: 'sea', path: '/terms-of-use/' }),
  openGraph: buildOpenGraph({ regionCode: 'sea', path: '/terms-of-use/', title: TITLE, description: DESCRIPTION }),
