...
export const metadata: Metadata = {
  ...
  description:
    'The Nootropic Lab is an independent cognitive-supplement comparison site operated by Kulik Media UG. Evidence-graded reviews, clinical dosing audits, transparent affiliate disclosure.',
