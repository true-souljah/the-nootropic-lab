...
import { guides, buildPersonAuthorReference, productsUS, regionalGuideNote, regionalTitleQualifier } from '@nootropic/data';
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: buildAlternates({ regionCode: 'us', path: `/guides/${guide}/` }),
  ...
  return (
    <PublicShell searchItems={searchItems} uiStrings={uiStrings}>
      ...
      <article className="max-w-3xl mx-auto px-4 py-10">
        ...
        <RegionalAvailability {...regionalProps(productsUS.slice().sort((a, b) => b.score - a.score).slice(0, 4))} note={regionalGuideNote('us', g.slug)} />
