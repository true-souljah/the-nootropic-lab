...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: buildOpenGraph({ regionCode: 'us', path: `/guides/${guide}/`, title: `${g.title} — The Nootropic Lab`, description: g.description }),
    twitter: buildTwitter({ title: `${g.title} — The Nootropic Lab`, description: g.description }),
  };
}
