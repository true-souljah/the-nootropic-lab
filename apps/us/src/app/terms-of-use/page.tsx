...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates({ regionCode: 'us', path: '/terms-of-use/' }),
  openGraph: buildOpenGraph({ regionCode: 'us', path: '/terms-of-use/', title: TITLE, description: DESCRIPTION }),
