...
// AU cognitive-accessibility probe — WCAG 3.1.4 (Abbreviations).
// PR-Q70.
//
...
// /tga-listed-cognitive-supplements/ — names FDA (Food and Drug
...
test.describe('AU — WCAG 3.1.4 Abbreviations on /tga-listed-cognitive-supplements/', () => {
  for (const { acronym, expansion } of ABBREVIATIONS) {
    test(`${acronym} is expanded somewhere on the page (either via <abbr title> or inline parenthetical)`, async ({
      ...
      await page.goto('/tga-listed-cognitive-supplements/');
