...
// AU cognitive-accessibility on BRAND REVIEW pages — content-tail
...
const ABBREVIATIONS = [
  ...
  // PR-Q85 region-specific regulator acronym
  { acronym: 'ARTG', expansion: 'Australian Register of Therapeutic Goods' },
];
...
test.describe('AU — WCAG 3.1.4 Abbreviations on brand review pages (content-tail)', () => {
