...
// AU heading-outline / document-structure probe. PR-Q74.
//
...
const ROUTES = [
  { path: '/tga-listed-cognitive-supplements/', template: 'TGA pillar' },
  { path: '/best-nootropics-for-focus/', template: 'Listicle' },
  { path: '/mind-lab-pro-review/', template: 'ProductDetail (international brand)' },
  { path: '/blackmores-brain-active-review/', template: 'AU brand (Blackmores)' },
  { path: '/ingredients/l-theanine/', template: 'IngredientDetail' },
];

test.describe('AU — heading outline / document structure', () => {
