...
// CA cognitive-accessibility probe — WCAG 3.1.4 (Abbreviations).
// PR-Q70.
//
...
// /npn-licensed-nootropics-canada/ — names FDA (Food and Drug
...
test.describe('CA — WCAG 3.1.4 Abbreviations on /npn-licensed-nootropics-canada/', () => {
