...
// CA cognitive-accessibility on COMPARISON pages — extension to
...
const COMPARISON_ROUTES = [
  '/aor-ortho-mind-vs-mind-lab-pro/',
];
...
test.describe('CA — WCAG 3.1.4 Abbreviations on comparison pages (content-tail)', () => {
