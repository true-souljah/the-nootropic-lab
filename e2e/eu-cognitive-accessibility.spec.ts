...
// EU cognitive-accessibility probe — WCAG 3.1.4 (Abbreviations).
// PR-Q70.
//
...
// /efsa-approved-cognitive-supplements/ — names FDA (Food and Drug
...
test.describe('EU — WCAG 3.1.4 Abbreviations on /efsa-approved-cognitive-supplements/', () => {
  for (const { acronym, expansion } of ABBREVIATIONS) {
    test(`${acronym} is expanded somewhere on the page (either via <abbr title> or inline parenthetical)`, async ({
      ...
      await page.goto('/efsa-approved-cognitive-supplements/');
