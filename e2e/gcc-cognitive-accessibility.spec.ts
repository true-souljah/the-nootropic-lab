...
// GCC cognitive-accessibility probe — WCAG 3.1.4 (Abbreviations).
// PR-Q70.
//
...
// /halal-certified-nootropics/ — names FDA (Food and Drug
...
test.describe('GCC — WCAG 3.1.4 Abbreviations on /halal-certified-nootropics/', () => {
