...
// JP cognitive-accessibility probe — WCAG 3.1.4 (Abbreviations).
// PR-Q70.
//
...
// /ffc-notified-cognitive-supplements/ — names FDA (Food and Drug
...
const ABBREVIATIONS = [
  { acronym: 'FFC', expansion: 'Foods with Function Claims' },
];
...
test.describe('JP — WCAG 3.1.4 Abbreviations on /ffc-notified-cognitive-supplements/', () => {
