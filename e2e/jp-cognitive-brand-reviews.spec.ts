...
// JP cognitive-accessibility on BRAND REVIEW pages — content-tail
...
const REVIEW_ROUTES = [
  ...
  '/hunter-focus-review/',
  '/fancl-brains-review/',
  '/suntory-dha-epa-sesamin-review/',
];
...
test.describe('JP — WCAG 3.1.4 Abbreviations on brand review pages (content-tail)', () => {
