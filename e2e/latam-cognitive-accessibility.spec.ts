...
// LATAM cognitive-accessibility probe — WCAG 3.1.4 (Abbreviations).
// PR-Q70.
//
...
// /anmat-disposicion-2105-2022-prohibidos/ — names FDA (Food and Drug
...
const ABBREVIATIONS = [
  { acronym: 'ANMAT', expansion: 'Administración Nacional de Medicamentos' },
];
...
test.describe('LATAM — WCAG 3.1.4 Abbreviations on /anmat-disposicion-2105-2022-prohibidos/', () => {
  for (const { acronym, expansion } of ABBREVIATIONS) {
    test(`${acronym} is expanded somewhere on the page (either via <abbr title> or inline parenthetical)`, async ({
      ...
      await page.goto('/anmat-disposicion-2105-2022-prohibidos/');
