...
// the LATAM app. Twin of us-reduced-motion (PR-Q23 #87).
//
...
test.describe('LATAM — global prefers-reduced-motion rule applies (WCAG 2.3.3 + 2.2.2)', () => {
...
test.describe('LATAM — keyframe animations also neutralized under reduced motion (WCAG 2.2.2)', () => {
