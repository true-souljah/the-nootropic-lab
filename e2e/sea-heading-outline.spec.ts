...
// SEA heading-outline / document-structure probe. PR-Q74.
//
...
const ROUTES = [
  { path: '/halal-nootropics-indonesia-bpjph/', template: 'SEA BPJPH pillar' },
  { path: '/best-nootropics-for-focus/', template: 'Listicle' },
  { path: '/mind-lab-pro-review/', template: 'ProductDetail (international brand)' },
  { path: '/naturebell-ginkgo-ginseng-review/', template: 'SEA brand (NatureBell)' },
  { path: '/ingredients/l-theanine/', template: 'IngredientDetail' },
];

test.describe('SEA — heading outline / document structure', () => {
