...
// US heading-outline / document-structure probe. PR-Q74.
//
...
const ROUTES = [
  { path: '/are-nootropics-fda-approved/', template: 'regulatory pillar' },
  { path: '/best-nootropics-for-focus/', template: 'Listicle' },
  { path: '/mind-lab-pro-review/', template: 'ProductDetail' },
  { path: '/alpha-brain-vs-qualia-mind/', template: 'HeadToHead' },
  { path: '/ingredients/l-theanine/', template: 'IngredientDetail' },
];

test.describe('US — heading outline / document structure', () => {
