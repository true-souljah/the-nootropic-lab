...
export const productsLatam: Product[] = [
  {
    ...
    summary: 'The most comprehensively researched nootropic stack on the market and our #1 pick for LATAM buyers seeking full cognitive support. Sold in USD only — no local currency option. Ships from the UK, typically arriving in 10–18 days. Mexican buyers should note the Comisión Federal para la Protección contra Riesgos Sanitarios (COFEPRIS) does not pre-approve imported supplements; Brazilian buyers face a higher rate of customs holds by the Agência Nacional de Vigilância Sanitária (ANVISA) and should budget extra time. Argentine buyers face currency controls that may complicate USD card payments. Colombians regulated by the Instituto Nacional de Vigilancia de Medicamentos y Alimentos (INVIMA), Chileans (ISP), and Peruvians (DIGEMID) can generally receive shipments with standard import duties.',
    whatItIs: 'Mind Lab Pro is an 11-ingredient nootropic stack made by Opti-Nutra, a UK-based supplement company, designed to cover memory, focus, mental energy, mood, and long-term brain health without caffeine or proprietary blends. For LATAM buyers, it is sold exclusively in USD with no local currency checkout. The product ships internationally from the UK and is not registered with regional health authorities such as the Comisión Federal para la Protección contra Riesgos Sanitarios (COFEPRIS) in Mexico, the Agência Nacional de Vigilância Sanitária (ANVISA) in Brazil, ANMAT (Argentina), the Instituto Nacional de Vigilancia de Medicamentos y Alimentos (INVIMA) in Colombia, ISP (Chile), or DIGEMID (Peru) — it enters as a personal-use imported supplement, which is permitted in most LATAM markets up to set quantity limits.',
  ...
  },
  {
    ...
    whatItIs: "NooCube is a 13-ingredient nootropic stack made by Wolfson Brands, a large supplement manufacturer. Its standout feature is Lutemax 2020 — a patented lutein and zeaxanthin extract researched for reducing digital eye strain and blue-light-related cognitive fatigue, making it relevant for screen-heavy workers. For LATAM buyers, NooCube is priced exclusively in USD and ships internationally as a personal-use supplement. It is not registered with the Comisión Federal para la Protección contra Riesgos Sanitarios (COFEPRIS) in Mexico, the Agência Nacional de Vigilância Sanitária (ANVISA) in Brazil, ANMAT (Argentina), the Instituto Nacional de Vigilancia de Medicamentos y Alimentos (INVIMA) in Colombia, ISP (Chile), or DIGEMID (Peru), and enters these markets under personal-import allowances. Customs duties vary by country and are the buyer's responsibility.",
  ...
  },
  {
    ...
    whatItIs: 'Qualia Mind is a 28-ingredient nootropic stack developed by Neurohacker Collective, a San Diego-based company focused on systems biology and complex supplementation. It is the most ingredient-rich formula in this review and targets experienced supplement users who want a comprehensive single-product cognitive stack. For LATAM buyers, it is sold exclusively in USD via a US storefront and ships internationally as a personal-use supplement. Qualia Mind is not registered with the Comisión Federal para la Protección contra Riesgos Sanitarios (COFEPRIS) in Mexico, the Agência Nacional de Vigilância Sanitária (ANVISA) in Brazil, ANMAT (Argentina), the Instituto Nacional de Vigilancia de Medicamentos y Alimentos (INVIMA) in Colombia, ISP (Chile), or DIGEMID (Peru) and enters LATAM markets under personal-import allowances. The high capsule count (7 per serving, 22 servings per container) may attract closer customs scrutiny in Brazil and Argentina.',
  ...
  },
  {
    ...
    whatItIs: "Alpha Brain is Onnit's flagship nootropic, first released in 2011 and popularised through Joe Rogan's podcast. It is the best-recognised nootropic brand in the mainstream US market and one of only two supplements in this review with published clinical trial data on its specific formula. It is National Sanitation Foundation (NSF) Certified for Sport. For LATAM buyers, Alpha Brain is sold exclusively in USD and ships from the US as a personal-use imported supplement. It is not registered with the Comisión Federal para la Protección contra Riesgos Sanitarios (COFEPRIS) in Mexico, the Agência Nacional de Vigilância Sanitária (ANVISA) in Brazil, ANMAT (Argentina), the Instituto Nacional de Vigilancia de Medicamentos y Alimentos (INVIMA) in Colombia, ISP (Chile), or DIGEMID (Peru). Import duties and potential customs holds are the buyer's responsibility — the US-based 90-day return policy does not cover return shipping costs from LATAM.",
  ...
  },
  {
    ...
    whatItIs: "Nootropics Depot Lion's Mane Extract is a single-ingredient supplement providing standardised Hericium erinaceus fruiting body extract at 500mg per capsule. Nootropics Depot is widely regarded as the most quality-focused retailer in the US nootropics market, operating an ISO-certified in-house testing lab and publishing a CoA for every batch — documentation that LATAM buyers can use to verify product identity if questioned by customs. For LATAM buyers, the product is priced exclusively in USD and ships from the US as a personal-use supplement. It is not registered with the Comisión Federal para la Protección contra Riesgos Sanitarios (COFEPRIS) in Mexico, the Agência Nacional de Vigilância Sanitária (ANVISA) in Brazil, ANMAT (Argentina), the Instituto Nacional de Vigilancia de Medicamentos y Alimentos (INVIMA) in Colombia, ISP (Chile), or DIGEMID (Peru), and enters these markets under personal-import allowances. The lower per-shipment value ($25 USD) reduces the likelihood of significant customs duties compared to higher-priced stacks.",
  ...
  {
    id: 'herbamz-neuromax',
    name: 'Herbamz NeuroMax',
    brand: 'Herbamz',
    slug: 'herbamz-neuromax-review',
    bestFor: ['Memory', 'Focus', 'Brazilian domestic brand'],
    score: 6.8,
    ...
    affiliateUrl: 'https://www.amazon.com.br/s?k=Herbamz+NeuroMax',
    affiliateNetwork: 'Amazon Associates BR',
    commissionRate: '3%',
    cookieDays: 24,
    heroIngredients: ['Bacopa Monnieri', 'Ginkgo Biloba', 'Phosphatidylserine', 'Vitamin B12'],
    ingredientDosages: [
    ...
    servingsPerContainer: 30,
    capsulesPerServing: 2,
    summary: 'Herbamz NeuroMax is an ANVISA-registered Brazilian nootropic supplement available directly on Amazon Brazil and Mercado Libre. Priced in BRL (approximately R$110/month, ~$22 USD) with no import duties, no customs risk, and same-day Prime delivery in major Brazilian cities. The most accessible entry point for Brazilian buyers who want to avoid international shipping entirely.',
    whatItIs: 'Herbamz NeuroMax is a Brazilian-made cognitive supplement registered with ANVISA (Agência Nacional de Vigilância Sanitária), Brazil\'s food and drug regulatory authority. Manufactured in São Paulo, it combines Bacopa Monnieri, Ginkgo Biloba, Phosphatidylserine, and Vitamin B12 in a caffeine-free formula. While ingredient doses are below clinical levels found in premium imported stacks, the product\'s key advantage for LATAM buyers is zero customs risk, BRL pricing, and next-day delivery via Amazon Prime Brazil or Mercado Libre. Available in major pharmacy chains (Drogasil, Raia, Pacheco) across Brazil.',
    howItWorks: 'Bacopa Monnieri supports memory consolidation via synaptic communication. Ginkgo Biloba improves cerebral blood flow through vasodilation and PAF inhibition. Phosphatidylserine supports neuronal membrane integrity and cortisol regulation. Vitamin B12 supports methylation pathways essential for neurotransmitter synthesis. The formula is conservative in dosing but uses well-established ingredients with safety profiles accepted by ANVISA.',
    whatToExpect: 'Weeks 1-2: no acute effects — this is a foundational supplement. Weeks 4-6: subtle improvements in recall and mental clarity. At 8+ weeks: modest cognitive maintenance benefit. Effects will be milder than premium imported stacks (Mind Lab Pro, NooCube) due to lower ingredient doses, but NeuroMax avoids the 10-18 day import wait, customs holds, and USD pricing that LATAM buyers face with international products.',
    pros: ['ANVISA-registered', 'BRL pricing — no USD conversion', 'Available on Amazon Brazil + pharmacies', 'No customs or import risk'],
  ...
  },
  {
    ...
    name: 'Genomma Lab NeuriPlus',
    brand: 'Genomma Lab',
    slug: 'genomma-lab-neuriplus-review',
    bestFor: ['Memory', 'Brain health', 'Mexican domestic brand'],
    score: 6.5,
    scoreBreakdown: { ingredients: 6, dosing: 5, transparency: 6, value: 8, trust: 7 },
    priceMonthlyUSD: 18,
    pricingModel: 'one-time',
    moneyBackDays: 0,
    caffeineFree: true,
    ...
    trustpilotScore: null,
    trustpilotCount: null,
    affiliateUrl: 'https://www.amazon.com.mx/s?k=Genomma+Lab+NeuriPlus',
    affiliateNetwork: 'Amazon Associates MX',
    commissionRate: '3%',
    cookieDays: 24,
    heroIngredients: ['Ginkgo Biloba', 'DHA', 'Vitamin B6', 'Vitamin B12'],
    ingredientDosages: [
    ...
    pros: ['COFEPRIS-registered', 'Available in pharmacies across 20+ LATAM countries', 'Local currency pricing (MXN/COP/PEN/CLP)', 'No import or customs risk'],
