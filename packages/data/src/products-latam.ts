...
export const productsLatam: Product[] = [
  {
    ...
    summary: 'The most comprehensively researched nootropic stack on the market. Ships internationally to Latam countries (Mexico, Brazil, Argentina, Colombia, Chile, Peru). Customs and import taxes may apply depending on your country. Our #1 pick for overall cognitive support.',
  ...
  },
  {
    ...
    servingsPerContainer: 30,
    capsulesPerServing: 4,
    summary: 'Strong formula anchored by Lutemax 2020. Best value per serving. Ships internationally to Latam countries (Mexico, Brazil, Argentina, Colombia, Chile, Peru). Customs and import taxes may apply. Note: Trustpilot score is very low -- verify independently before purchasing.',
  ...
  },
  {
    ...
    summary: '28 active ingredients -- the most comprehensive formula. Ships internationally to Latam countries (Mexico, Brazil, Argentina, Colombia, Chile, Peru). Customs and import taxes may apply. Best for experienced biohackers.',
  ...
  },
  {
    ...
    summary: 'Most commercially successful US nootropic. Backed by two clinical studies. Ships internationally to Latam countries (Mexico, Brazil, Argentina, Colombia, Chile, Peru). Customs and import taxes may apply.',
  ...
  },
  {
    ...
    summary: '4 personalised formula blends per month. Ships internationally to Latam countries (Mexico, Brazil, Argentina, Colombia, Chile, Peru). Customs and import taxes may apply. Best for people who want to experiment.',
  ...
  },
  {
    ...
    summary: "Gold standard for single-ingredient Lion's Mane. Ships internationally to Latam countries (Mexico, Brazil, Argentina, Colombia, Chile, Peru). Customs and import taxes may apply. ISO in-house lab publishes CoA per batch.",
