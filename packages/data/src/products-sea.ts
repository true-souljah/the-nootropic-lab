...
export const productsSEA: Product[] = [
  {
    ...
    summary: 'The most comprehensively researched nootropic stack on the market. Popular choice in Singapore. Ships internationally to Southeast Asia. HSA (Singapore) / BPOM (Indonesia) registration not confirmed -- imported as personal use supplement. Our #1 pick for overall cognitive support.',
  ...
  },
  {
    ...
    servingsPerContainer: 30,
    capsulesPerServing: 4,
    summary: 'Strong formula anchored by Lutemax 2020. Best value per serving. Ships internationally to Southeast Asia. HSA (Singapore) / BPOM (Indonesia) registration not confirmed -- imported as personal use supplement. Note: Trustpilot score is very low -- verify independently before purchasing.',
  ...
  },
  {
    ...
    summary: '28 active ingredients -- the most comprehensive formula. Ships internationally to Southeast Asia. HSA (Singapore) / BPOM (Indonesia) registration not confirmed -- imported as personal use supplement. Best for experienced biohackers.',
  ...
  },
  {
    ...
    summary: 'Most commercially successful US nootropic. Backed by two clinical studies. Ships internationally to Southeast Asia. HSA (Singapore) / BPOM (Indonesia) registration not confirmed -- imported as personal use supplement. Caffeine-free formula.',
  ...
  },
  {
    ...
    summary: '4 personalised formula blends per month. Ships internationally to Southeast Asia. HSA (Singapore) / BPOM (Indonesia) registration not confirmed -- imported as personal use supplement. Best for people who want to experiment.',
  ...
  },
  {
    ...
    summary: "Gold standard for single-ingredient Lion's Mane. Ships internationally to Southeast Asia. HSA (Singapore) / BPOM (Indonesia) registration not confirmed -- imported as personal use supplement. ISO in-house lab publishes CoA per batch. Popular with Singapore buyers for its lab transparency.",
