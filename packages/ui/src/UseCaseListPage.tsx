    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 py-10">
        ...
        <aside className="bg-amber-50 border-l-4 border-amber-400 rounded-r-lg p-4 mb-6 text-sm text-amber-900">
          ...
          {healthDisclaimer || DEFAULT_DISCLAIMER}
        </aside>
        ...
        <section className="my-10">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">What the evidence actually says</h2>
          <p className="text-sm text-gray-600 mb-5 leading-relaxed">
            For each ingredient below, we link directly to the peer-reviewed source. Ingredient mechanism is not
            the same as product efficacy — a product can include the right ingredient at the wrong dose.
          </p>
        ...
        {/* Picks */}
        <section className="my-10">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Our picks for {useCase}</h2>
          <p className="text-sm text-gray-500 mb-6">
            Ranked by how well each product matches the evidence above + our 5-pillar editorial audit.
          </p>
            ...
            {sortedPicks.map((pick, i) => (
              ...
              >
                <div className="flex items-start gap-4 mb-3">
                  ...
                  <div className="flex-1">
                    <div className="flex flex-wrap items-center gap-2 mb-1">
                      {i === 0 && <span className="editor-badge">Top pick</span>}
                ...
                <p className="text-sm text-gray-700 leading-relaxed mb-4">
                  <strong className="text-gray-900">Why it's here:</strong> {pick.whyItsHere}
                </p>
        ...
        <section className="my-10 bg-green-50 border border-green-200 rounded-xl p-6">
          <h2 className="text-xl font-bold text-green-900 mb-2">How we choose</h2>
          <p className="text-sm text-gray-700 leading-relaxed mb-3">
            Every pick must (a) include at least one ingredient with peer-reviewed evidence for the use case,
            (b) dose that ingredient at or near the clinical-trial dose, and (c) score ≥ 7.5/10 in our
            5-pillar editorial audit. Read our{' '}
            <Link href="/methodology/" className="text-green-700 underline">full methodology</Link> for the
            scoring framework.
          </p>
